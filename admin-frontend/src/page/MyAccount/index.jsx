                ...
                <div className="account-wrapper">
                    ...
                    <div className="account-content">
                                    ...
                                    <div className="account-form-field">
                                        ...
                                        {updateToggle
                                            ...
                                            <>
                                                ...
                                                <div>
                                                    <Button disabled={isLoad} variant="contained" color="primary" type="submit">Cập nhật</Button>
                                                    <Button color="default" disableElevation onClick={() => setUpdateToggle(false)}><Close /></Button>
                                                </div>
                                            </>
                                            :
                                            <>
                        ...
                        <div className="account-element account-form-field">
                            ...
                            <div className="account-element-action" onClick={() => setVisiablePassword(true)}>Thay đổi</div>
                                    ...
                                    <form onSubmit={handleSubmit(handleChangePassword)}>
                                        <div className="profile-form-field">
                                            ...
                                            <div className="password-input-wrapper">
                                                <input type={passwordShown.password ? "text" : "password"} className="profile-form-input" name="old_password" autoFocus
                                                    ref={register({
                                            ...
                                            <div className="password-input-wrapper">
                                                <input type={passwordShown.new_password ? "text" : "password"} className="profile-form-input" name="password"
                                                    ref={register({
                                                        required: "Bạn hãy điền password ",
                                                        minLength: {
                                                            value: 6,
                                            ...
                                            <div className="password-input-wrapper">
                                                <input type={passwordShown.confirm_password ? "text" : "password"} name="password_repeat" className="profile-form-input"
                                                    ref={register({
                                                        // required: "Bạn hãy điền password ",
                                                        validate: value =>
                                        ...
                                        <div className="account-submit">
                                            <Button disabled={isLoad} variant="contained" color="primary" type="submit">Đổi mật khẩu</Button>
                                        </div>
                                    </form>
                                </div>
                            </Modal>
